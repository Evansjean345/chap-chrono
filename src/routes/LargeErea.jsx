...
import Hero from "../components-erea/Hero";
import bgTwo from "../bg-two.png";
import Content from "../components-erea/Content";
import CardAndSwiper from "../components-erea/CardAndSwiper";
import ContentTwo from "../components-erea/ContentTwo";
import Footer from "../layouts/Footer";
import AppFooter from "../layouts/AppFooter";

export default function LargeErea() {
  const navRef = useRef();
