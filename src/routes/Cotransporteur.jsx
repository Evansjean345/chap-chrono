...
import HeroCotrans from "../components-com/HeroCotrans";
import bgTwo from "../bg-co.png";
import ContentCo from "../components-com/ContentCo";
import Footer from "../layouts/Footer";
import AppFooter from "../layouts/AppFooter";

export default function Cotransporteur() {
  const navRef = useRef();
