...
import bg from "../bg-particulier.png";
import Footer from "../layouts/Footer";
import AppFooter from "../layouts/AppFooter";
import "../App.css";
import CommercantContent from "../components/CommercantContent";
      ...
      >
        <NavLink>
          <nav className="flex w-full h-[10vh] pt-8 bg-none" id="navLink">
            <div className="w-[12%] ml-20">
              <Link to="/">
                <img src="/logo/logo-text.png" alt="" srcset="" />
              </Link>
            </div>
              ...
              <ul className="flex justify-evenly mt-12 ">
                ...
                <li>
                  <div className="dropdown dropdown-left dropdown-hover">
                    <label
                      tabIndex={0}
                      className="hover:bg-[#4D148C] text-[#4D148C] bg-white rounded-full p-3 px-10 hover:text-white"
                    >
                      Ça m'intérresse
                    </label>
                    <div
        ...
        <NavLink className="nav-res justify-between w-full flex z-30 pr-5 md:mt-10">
          <div className="md:w-[20%] w-[30%]">
            <img src="/logo/logo-text.png" alt="" />
          </div>
            ...
            <li className="md:px-16 px-4 mt-6">
              <div className=" py-4  px-12  border-gray-200">
                ...
                >
                  <button
                    onClick={() => setShow2(!show2)}
                    className="hover:bg-[#37145d] bg-[#4D148C] rounded-full p-3 px-3  text-white"
                  >
